...
var io = require('socket.io')(http,{	'pingInterval': 40000,
	'pingTimeout': 25000});
var i;
var net = require('net');

var chatscriptConfig = {port: 1337, host: 'localhost', allowHalfOpen: true};
...
// Déconnexion d'un utilisateur
  ...
  socket.on('chat-message', function (message) {
    ...
    var chatscriptSocket = net.createConnection(chatscriptConfig, function(){
        payload = message.username+'\x00'+chatscriptBot+'\x00'+message.text+'\x00'
